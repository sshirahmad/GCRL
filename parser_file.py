...
def get_training_parser():
    ...
    parser.add_argument("--num_epochs", default='2-2-2-2-2', type=lambda x: int_tuple(x, '-'))  # '150-100-150',
    parser.add_argument("--resume", default="./models/E1/P3/CRMF_epoch_265.pth.tar",
