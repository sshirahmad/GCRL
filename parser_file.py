...
def get_parser():
    ...
    parser.add_argument("--z_dim", type=int, default=20, help="Dimension of z latent variable")
    parser.add_argument("--s_dim", type=int, default=20, help="Dimension of s latent variable")
