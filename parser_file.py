...
def get_training_parser():
    ...
    parser.add_argument("--num_epochs", default='150-100-400-200', type=lambda x: int_tuple(x, '-'))  # '150-100-150',
    parser.add_argument("--resume", default="./models/eth/CRMF_risk_irm_5.0_batch_hom_data_eth_ds_0_bk_20_ep_(150, 100, 150, 200)_shuffle_true_seed_72/pretrain/P3/CRMF_epoch_506.pth.tar",
