...
def main(args):
    ...
    if args.dataset_name in ["eth", "hotel", "zara1", "zara2", "univ"] and args.exp == 'pretrain' or args.exp == 'all':
    ...
    # pretrain exp
    if args.dataset_name == "v4" and args.exp == 'pretrain' or args.exp == 'all':
        print(f'\nRESULTS\nDataset: {args.dataset_name}\n\nPretrain: ')
        result = pd.read_csv(f'results/{args.dataset_name}/pretrain/summary.csv', sep=', ', engine='python')
    ...
    # finetune exp
    print('\n\Finetune: ')
    if args.dataset_name == "v4" and args.exp == 'finetune' or args.exp == 'all':
